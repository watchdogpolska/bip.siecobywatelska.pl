...
/**
 * @ORM\Entity(repositoryClass="Sowp\NewsBundle\Entity\NewsRepository")
 * @ORM\Table(name="news")
 * @Audit\Auditable()
...
class News
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Sowp\NewsBundle\Entity\Collection", inversedBy="news")
     ...
     * Add collection.
     *
     * @param \NewsBundle\Entity\Collection $collection
     *
     * @return News
     */
    public function addCollection(\Sowp\NewsBundle\Entity\Collection $collection)
    {
     ...
     * @param \NewsBundle\Entity\Collection $collection
     */
    public function removeCollection(\Sowp\NewsBundle\Entity\Collection $collection)
    {
