...
class NewsController extends Controller
{
    ...
    {
        $news = new News();
        $form = $this->createForm('Sowp\NewsBundle\Form\NewsType', $news);
    ...
    {
        $deleteForm = $this->createDeleteForm($news);
        $editForm = $this->createForm('Sowp\NewsBundle\Form\NewsType', $news);
    ...
    public function revisionlistAction(News $news)
    {
        ...
        return $this->render('NewsBundle:news:revlist.html.twig', [
            'news' => $news,
            'revisions' => $revisions,
        ]);
    }
