...
namespace Sowp\NewsBundle\Controller;
...
use Sowp\NewsBundle\Form\addCollectionForm as addForm;
...
class CollectionController extends Controller
{
    ...
    public function queryAction(Request $request)
    {
        ...
        $repo = $this->getDoctrine()
                ->getRepository('Sowp\NewsBundle\Entity\Collection');
    ...
    public function addAction(Request $req)
    {
        ...
        return $this->render('NewsBundle:collection:add.html.twig', [
    ...
    public function editAction(Request $req, Collection $collection)
    {
        ...
        return $this->render('NewsBundle:collection:edit.html.twig', [
            'form' => $form->createView(),
        ]);
    }
    ...
    public function indexAction()
    {
        ...
        $collections = $em->getRepository('NewsBundle:Collection')->findAll();

        return $this->render('NewsBundle:collection:index.html.twig', array(
    ...
    {
        return $this->render('NewsBundle:collection:show.html.twig', array(
